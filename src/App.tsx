...
export default function App() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FFE600] flex items-center justify-center border-[12px] border-black">
        <div className="text-center font-black text-4xl uppercase animate-bounce italic">
          MAGIC IS LOADING...
        </div>
      </div>
    );
        ...
        <header className="px-6 py-4 border-b-[4px] border-black bg-white flex justify-between items-center top-0 z-20 sticky neo-shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              onClick={() => { playClickSound(); setShowApiKeyModal(true); }}
              className="neo-btn bg-[#FFDE59] border-2 border-black p-2 neo-shadow-sm"
            >
              <Key size={20} />
            </motion.button>
            ...
            {profile?.role === 'admin' && (
              <button
                ...
                className="neo-btn bg-[#00E5FF] border-2 border-black px-3 py-1.5 md:px-4 md:py-2 font-black text-xs md:text-sm uppercase neo-shadow-sm"
              >
                ADMIN
              </button>
            )}
            ...
            <button
              ...
              className="neo-btn bg-black text-white border-2 border-black p-2 neo-shadow-sm"
            >
              <LogOut size={20} />
            </button>
          </div>
              ...
              <div className="bg-white border-[6px] border-black max-w-md w-full rounded-[40px] overflow-hidden neo-shadow animate-scale-in">
                ...
                <div className="p-8 space-y-8">
                  <div className="text-center">
                    ...
                    <a href="https://www.notion.so/CARA-MENDAPAT-API-KEY-GOOGLE-31da0717493f801399b9d5cd19a8b122?source=copy_link" target="_blank" rel="noopener noreferrer" className="neo-btn w-full bg-[#FFDE59] border-4 border-black py-4 px-6 flex items-center justify-center gap-3 font-black text-sm uppercase neo-shadow-sm">
